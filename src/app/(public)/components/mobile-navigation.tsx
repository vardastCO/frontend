    ...
    isTabletOrMobile && (
      <div>
        <div
          ...
          aria-hidden="true"
        ></div>
        <div className="fixed bottom-0 left-0 z-50 h-16 w-full border-t border-gray-200 bg-white bg-opacity-50 pb-[env(safe-area-inset-bottom)] backdrop-blur-xl dark:border-gray-600 dark:bg-gray-700">
          <div className="mx-auto grid h-full max-w-lg grid-cols-3 font-medium">
            ...
            <Button
              noStyle
              onClick={() => setCategoriesFilterState(!categoriesFilterState)}
              type="button"
              className="group inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800"
            >
